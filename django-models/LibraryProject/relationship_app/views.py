...
def librarian_view(request):
    """
    This view is only accessible to users in the 'Librarian' group.
    """
    return HttpResponse("Welcome to the Librarian Portal.")

@user_passes_test(is_member, login_url='/accounts/login/')
def member_view(request):
    """
    This view is only accessible to users in the 'Member' group.
    """
    return HttpResponse("Welcome, valued Member.")
def is_admin(user):
